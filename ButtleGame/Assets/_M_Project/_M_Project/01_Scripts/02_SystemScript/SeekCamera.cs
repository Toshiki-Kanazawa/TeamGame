...
void Start()
    {
        ...
        prevTargetPos = parent.transform.position;
    ...
    void Update()
    {
        ...
        {
            this.transform.position += parent.transform.position - prevTargetPos;
            prevTargetPos = parent.transform.position;
        ...
        {
            // プレイヤーの座標についていく
            this.gameObject.transform.position = parent_Transform.position + offset_LockDown;
            // プレイヤーの方向を向く
            this.transform.LookAt(parent_Transform);
        }
    }
